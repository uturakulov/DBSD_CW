...
go
insert into Staff(staff_id, first_name, last_name, email, salary, married, photo, age, gender, role, branch_id) 
values (1, 'John', 'Doe', 'jdoe@mail.com', 2000000, 1, CAST('Image' AS VARBINARY(MAX)), 20, 'M', 'Chief', 1), (2, 'Pamela', 'Doe', 'pdoe@mail.com', 2500000, 1, CAST('Image' AS VARBINARY(MAX)), 20, 'M', 'Chief', 1),
(3, 'Andy', 'Smith', 'asmith@mail.com', 1000000, 1, CAST('Image' AS VARBINARY(MAX)), 20, 'F', 'Chief', 2), (4, 'Michael', 'Jackson', 'mjack@mail.com', 3500000, 0, CAST('Image' AS VARBINARY(MAX)), 20, 'M', 'Chief', 2)
go
